...
int main()
{
    ...
    // Shader fbShader("./shaders/framebuffer.vs", "./shaders/invert.fs");
    // Shader fbShader("./shaders/framebuffer.vs", "./shaders/grayscale.fs");
    Shader fbShader("./shaders/framebuffer.vs", "./shaders/kernel.fs");
